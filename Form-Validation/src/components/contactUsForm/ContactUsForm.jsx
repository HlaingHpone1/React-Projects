    ...
    return (
        <div>
            <form className="min-w-[350px]" action="" onSubmit={submitHandler}>
                ...
                <div className="input-box mb-3">
                    <textarea
                        className={`focus:outline-none bg-transparent border-b-2  focus:border-slate-700 transition-colors duration-200 ease-linear w-full block text-lg px-2 py-2.5 resize-none h-24 ${errors.email ? "border-red-400" : "border-slate-300"}`}
                        name="message"
                        id="message"
                        value={data.message}
                        onChange={inputHandler}
